...
export default function Nav1({ data }: Nav1Props) {
    ...
    return (
        <div className="fixed right-0 left-0 lg:top-10 top-0 w-full h-16.25 max-w-310 mx-auto px-5 flex items-center justify-between lg:bg-background/60 bg-background/85 backdrop-blur-md backdrop-saturate-150
